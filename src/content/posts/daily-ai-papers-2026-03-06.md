...
| 论文 | 主题 | 方向 | 核心贡献 | 评级 |
|------|------|------|----------|------|
| DMAST | 对抗训练 | Agentic RL | 双模态多阶段对抗训练，增强 Web Agent 鲁棒性 | ⭐⭐⭐ |
| AAJR | 鲁棒性 | Agentic AI | 对抗对齐雅可比正则化，提升 minimax 稳定性 | ⭐⭐⭐ |
| DEVS World Models | 世界模型 | World Models | 基于形式化的离散事件世界模型生成与验证 | ⭐⭐⭐ |
| RoboCasa365 | 机器人基准 | VLA | 365 任务大规模通用机器人仿真基准 | ⭐⭐ |
| Phi-4-reasoning-vision | 多模态推理 | Multimodal | 15B 多模态推理模型，数据质量为核心 | ⭐⭐ |
| Evaluation-Awareness | LLM 安全 | Safety | 上下文环境诱导评估意识与 sandbagging | ⭐⭐ |
| BeamPERL | RLVR 物理 | Physics | RLVR 在物理推理中的能力与局限 | ⭐⭐ |
...
*Generated by Amy on 2026-03-06*  
*Data source: arXiv (Mar 6, 2026)*
