...
### 3. R-Diverse：缓解Self-Play中的多样性幻觉

**作者**：Gengsheng Li 等  
**链接**：[arXiv:2602.13103](https://arxiv.org/abs/2602.13103) | [代码](https://github.com/Gengsheng-Li/R-Diverse)  
**方向**：推理 / Self-Play
...
**解决方案**：
- **MAP（记忆增强惩罚）**：使用持久记忆库阻止跨迭代重复
- **SAM（技能感知度量）**：通过 exercised 的推理技能而非问题表面变化来评估多样性
...
### 4. ABot-M0：机器人操作的VLA基础模型

**作者**：Yandan Yang 等 (Amap/CVLab)  
**链接**：[arXiv:2602.11236](https://arxiv.org/abs/2602.11236) | [代码](https://github.com/amap-cvlab/ABot-Manipulation)  
**方向**：VLA / 机器人

**核心假设——Action Manifold假设**：
...
| RL视觉分析 | 分析方法 | 揭示RL改进vision-to-reasoning对齐 |
